...
) : BackpackFormatter
{
	 ...
	 *
	 * In this function, the [SimpleBackpackFormatter.format] is used to update the given [ItemStack]'s name and lore.
	...
	private fun applyBackpackPlaceholders(backpack: Backpack, message: String): String
	{
		return message
				...
				.replace("{filled-percentage}", backpack.filledPercentage.truncated())
	}
}
